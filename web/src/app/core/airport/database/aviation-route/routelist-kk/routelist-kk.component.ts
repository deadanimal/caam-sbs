...
import * as RouteListKK from "src/app/variables/routelist-kk";
...
@Component({
  selector: "app-routelist-kk",
  templateUrl: "./routelist-kk.component.html",
  styleUrls: ["./routelist-kk.component.scss"],
})
export class RoutelistKkComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
  rows = []; //RouteListKK.RouteListKK;
