...
@Component({
  selector: "app-airline-management-report",
  templateUrl: "./airline-management-report.component.html",
  styleUrls: ["./airline-management-report.component.scss"],
})
export class AirlineManagementReportComponent implements OnInit {
