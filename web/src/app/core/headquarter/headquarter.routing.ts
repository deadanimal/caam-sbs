...
export const HeadquarterRoute: Routes = [
    {
        ...
        children: [
            ...
            {
                path: 'database',
                loadChildren: () => import('./database/database.module').then(m => m.HeadquarterDatabaseModule)
            },
            {
                path: 'management',
            ...
            },
            {
                ...
                loadChildren: () => import('./vfrv/vfrv.module').then(m => m.HeadquarterVfrvModule)
            },
            {
                path: 'approval',
                children: [
            ...
            {
                path: 'finance',
                loadChildren: () => import('./finance/finance.module').then(m => m.HeadquarterFinanceModule)
            },
            {
                path: 'utility',
                loadChildren: () => import('./utility/utility.module').then(m => m.HeadquarterUtilityModule)
            },
            {
                path: 'payment',
                loadChildren: () => import('./payment/payment.module').then(m => m.HeadquarterPaymentModule)
            },
            // {
