...
@Component({
  selector: "app-advanced-payment-report-list",
  templateUrl: "./advanced-payment-report-list.component.html",
  styleUrls: ["./advanced-payment-report-list.component.scss"]
})
export class AdvancedPaymentReportListComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
