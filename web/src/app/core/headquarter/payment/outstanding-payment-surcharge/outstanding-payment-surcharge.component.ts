...
@Component({
  selector: "app-outstanding-payment-surcharge",
  templateUrl: "./outstanding-payment-surcharge.component.html",
  styleUrls: ["./outstanding-payment-surcharge.component.scss"]
})
export class OutstandingPaymentSurchargeComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
