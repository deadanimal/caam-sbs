...
import * as UserPrivileges from "src/app/variables/utility/user-privileges";
...
export class UserPrivilegeComponent implements OnInit {
  ...
  temp = [];
  activeRow: any;
  rows = UserPrivileges.UserPrivileges;
  ...
  editUserPrivilege(row, content) {
    this.formInput = row;
    this.open(content, "modal-mini", "sm", "Edit User Privilege");
  }
