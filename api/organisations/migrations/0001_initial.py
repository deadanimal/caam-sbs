    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cid', models.CharField(default='NA', max_length=4)),
                ('organisation_type', models.CharField(choices=[('AL', 'Airline'), ('MN', 'Manufacturer'), ('OT', 'Others')], default='OT', max_length=2)),
                ...
                ('address_line_1', models.CharField(default='NA', max_length=100)),
                ('address_line_2', models.CharField(default='NA', max_length=100)),
                ('address_line_3', models.CharField(default='NA', max_length=100)),
