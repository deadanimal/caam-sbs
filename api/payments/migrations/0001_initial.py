    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_uploaded_data', to='operations.Upload')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reminder_uploaded_data', to='operations.Upload')),
            ],
            options={
                'ordering': ['-created_at'],
            },
