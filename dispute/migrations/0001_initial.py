# Generated by Django 2.2.6 on 2021-01-21 01:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dispute_no', models.CharField(blank=True, default='NA', max_length=20)),
                ...
                ('fpl_ids', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=200), blank=True, size=None)),
                ('assign_to', models.CharField(blank=True, default='NA', max_length=200)),
            ],
        ),
    ]
